                        ...
                        <form action="{{ route('employee.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row col-md-11 text-left">
                                <div class="form-group  {{ $errors->has('first_name') ? 'has-error' : '' }}  col-sm-4 offset-sm-2">
                                    ...
                                    <input type="text" name="first_name" placeholder="donald"  class="form-control" id="first_name" >
                                    <span class="text-danger"> {{ $errors->first('first_name') }} </span>
                                </div>
                                <div class="form-group  {{ $errors->has('last_name') ? 'has-error' : '' }}  col-sm-4 offset-sm-1">
                                    <label for="last_name">Last Name</label>
                                    <input type="text" name="last_name" placeholder="trump"  class="form-control" id="last_name" >
                            ...
                            <div class="form-row col-md-11 text-left">
                                <div class="form-group  {{ $errors->has('email') ? 'has-error' : '' }}  col-sm-4 offset-sm-2">
                                    ...
                                    <input type="text" name="email" placeholder="titan@gmail.com"  class="form-control" id="email" >
                                    <span class="text-danger"> {{ $errors->first('email') }} </span>
                                </div>
                                <div class="form-group  {{ $errors->has('contact') ? 'has-error' : '' }}  col-sm-3 offset-sm-1">
                                    <label for="contact">Contact</label>
                                    <input type="text" name="contact" placeholder="9400000000"  class="form-control" id="contact" >
